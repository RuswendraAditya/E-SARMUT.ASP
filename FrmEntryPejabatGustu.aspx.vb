...
Partial Class FrmEntryPejabatGustu
    ...
    Private Sub SaveSigner()
        ...
        Try
            strsql = "Insert Into Mutu_Mapping_Signer (vc_k_gugus,vc_nik,dt_created_date,vc_created_by,dt_last_updated_date,vc_last_updated_by) " & _
            " VALUES ('" & Me.RadComboGustu.SelectedValue & "','" & Me.RadComboNIK.SelectedValue & "', " & _
    ...
    Private Sub updateSigner()
        ...
        MyTrans = connection.BeginTransaction()
        command.Transaction = MyTrans
        Dim kodeGugus As String = Me.RadComboGustu.FindItemByText(RadComboGustu.Text).Value
        Dim nik As String = Me.RadComboNIK.FindItemByText(RadComboNIK.Text).Value
        Try
            strsql = " UPDATE Mutu_Mapping_Signer set  " & _
                " vc_k_gugus = '" & kodeGugus & "' " & _
                ",vc_nik = '" & nik & "' " & _
                ",dt_last_updated_date = '" & MasterLib.GetCurrentDate & "' " & _
                ",vc_last_updated_by = '" & Session("ssusername") & "' " & _
                " where vc_k_gugus = '" & Request.QueryString("gustu") & "' "
