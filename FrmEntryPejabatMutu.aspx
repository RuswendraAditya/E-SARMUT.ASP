<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmEntryPejabatMutu.aspx.vb" Inherits="FrmEntryPejabatMutu" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <form class="form-horizontal" runat="server">
      ...
      <div class="form-group">
          <label for="RadComboNIK" class="control-label col-xs-2" style="font-size: small">Pejabat Komite Mutu</label>
          <div class="col-xs-10">
              <telerik:RadComboBox ID="RadComboNIK" Font-Size="Small" RenderMode="Lightweight" runat="server" Width="220" DropDownAutoWidth="Enabled" EmptyMessage="Pilih Nama Pejabat" class="form-control" Filter="Contains" MarkFirstMatch="true">
                ...
                <asp:RequiredFieldValidator runat="server"
                  ...
                  ErrorMessage="* Wajib Memilih Nama Pejabat Komite Mutu "
                  Display="Dynamic">
